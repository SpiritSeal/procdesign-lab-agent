...
int main(int argc, char** argv, char** env) {
    ...
    // Report Branch Prediction Accuracy
    int bp_correct = (int)dut->pipeline->my_AGEX_stage->bp_correct_AGEX_reg;
    int bp_total = (int)dut->pipeline->my_AGEX_stage->bp_total_AGEX_reg;
    if (bp_total > 0) {
        float accuracy = (float)bp_correct / bp_total * 100.0f;
